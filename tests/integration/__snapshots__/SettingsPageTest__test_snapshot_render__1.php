<?php return '<form action=\'options.php\' method=\'post\' class="gattiny">
	...
	<h1>Gattiny Settings</h1>

	<div>
		<img class="full-width" src="http://gattiny.local/wp-content/plugins/gattiny/assets/images/gattiny-header.png" alt="Gattiny settings header image">
	</div>
